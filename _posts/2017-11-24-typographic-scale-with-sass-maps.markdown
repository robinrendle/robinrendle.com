...
_The other day [Tim Brown](http://nicewebtype.com/) noticed that this old post had been deleted and so I rescued it from the Wayback Machine. Several years ago I wrote about a new typesetting system that we developed at [Erskine](http://erskine.simplygoodwork.com/). A lot of this code wasn’t written by me, but I did contribute to some of the underlying ideas. Most of the credit however should be directed to Mat Hayward and Tom Davies of [Kind](https://madebykind.com/) fame._
