...
Before newsletters and social networks there was RSS, a technology that let you subscribe to websites and see when something new had been posted. It was relatively simple, too: through a web-based interface, such as [Google Reader](https://www.google.com/reader/about/), you could subscribe to a website’s feed, see everything that had been posted and never have to type in the URL, hit a search engine or find it in your bookmarks. On the developer side and under the hood, a web designer would write a little bit of code to post all of their website’s content in a format that something like Google Reader could then scrape and serve to you.
