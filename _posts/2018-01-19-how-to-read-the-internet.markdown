...
From a design point of view, RSS was the feed before the Feed™️. You could see all of your subscriptions of every website at a quick glance but we have that now with Twitter and Facebook, so who cares? *“We don’t need RSS any more”* you might say. But! I believe that RSS was much more than just a fad — it made blogging possible for the first time because you could follow dozens of writers at the same time. There were no ads (except for the high quality Daring Fireball kind of ads), no one could slow down your feed reader with third party scripts, it had a good set of typographic and design standards and, most of all, it was _quiet_. Just the writer’s thoughts and you. No comments. No retweets. *“Hush, here is a blog.”* RSS would say.
