...
Why did RSS (or Really Simple Syndication) exist in the first place though? Well, strangely enough, you’d have to visit a website multiple times a day just to see if something new had been posted. There was no Twitter or Facebook, and so thankfully RSS solved that problem since we could now immediately see when something had been published. 
