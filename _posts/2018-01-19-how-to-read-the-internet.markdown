...
Why did RSS (or Really Simple Syndication) exist in the first place though? Well, strangely enough, if you liked a webpage then you’d have to visit it multiple times a day just to see if something new had been posted. There was no Twitter or Facebook, and so thankfully RSS solved that problem pretty well since you could now immediately see when something had been published. 
