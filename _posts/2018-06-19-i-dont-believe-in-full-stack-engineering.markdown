...
Yes, learning these things or having knowledge of these things is possible to do if you’re an engineer. But doing them well? Heck, doing them to an acceptable standard? This line of work requires above all else, dedication and focus because yesterday’s hacks become today’s standards and you simply don’t have time to keep up with front-end development if it’s a side gig.
