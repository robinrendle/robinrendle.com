...
But then I think beyond the language and get all sour when I think about [link rot](https://www.tbray.org/ongoing/When/201x/2015/05/25/URI-decay). Even some of the old stuff here on my site, like [The New Web Typography](https://robinrendle.com/essays/new-web-typography/), which looks like it’s slowly sinking into the mud. The first thing to stop working was the fonts. Then one day the JavaScript for some of the examples stopped working. 
