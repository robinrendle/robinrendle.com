...
But the biggest flaw with all this digital preservation stuff isn’t HTML or CSS in my opinion. _It’s the concept of a domain that we rent._ Today we borrow spaces on the web and put up our flimsy little flags on top. And then the links get lost in a shuffle. Or when someone unplugs something. Or, tragically, if someone dies. Above all things is the part of the web that shows the least amount of resilience.