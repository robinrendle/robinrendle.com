...
dateRange: 2016-2018
role: |
  Led the design and development of the design system and its many React components.
customCSSClass: guide
results: |
  High quality front-end code and documentation for the components and assets, such as logos, illustrations, and icons.
extract: |
