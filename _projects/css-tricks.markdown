...
extract: 'Since early 2015 I’ve been a regular contributor to [<abbr title=''Cascading
  ...
  those years I’ve written a number of articles and tutorials that explore new browser
  features and written in-depth articles on the peculiarities of <abbr title=''Cascading
  style sheets''>CSS</abbr>, JavaScript and HTML. It’s been a wonderful opportunity
  to improve my front-end and writing skills '
