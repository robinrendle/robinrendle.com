...
<p>As much as I agree with Marcin’s argument and as much as <a href="https://medium.com/@mwichary/what-i-learned-about-languages-just-by-looking-at-a-turkish-typewriter-fc840aab1b0a#.m43t2vly9">his relationship with typewriters is a complicated one</a>, I can’t help but play devil’s advocate a little here; I mean, sure, the printed matter that was produced by these machines certainly wasn’t “good typography” by the standards of the time but it’s important to remember that the art of typography is not merely what is output at the end of the writing process. Typography is so much more than the letters printed on the page.</p>
...
<p>The same can be said for the Declaration of Independence: the type was not American but rather comically the letters came from the London foundry Caslon, which was the regal “letter-founder to the King.” Not only that but the titles are tracked too far apart and the measure of each paragraph is much too wide for comfortable reading. But we must ignore these features because of the speed in which this document had to be printed. Our standards for “good typography” rarely takes this into account, but any typography is better than none at all.</p>
...
<blockquote>
<p>It soon dawned on me that just moving a few things around isn’t going to cut it. It’s like playing with a water balloon. If you squeeze on one side, it bulges on other sides.</p>
</blockquote>

<p>I love this idea! But manipulating a water balloon seems to be an apt metaphor for typography and design in general, let alone the configuration of a keyboard. For instance, if we make one element of a page colorful or larger than the rest then we in turn make all the other elements <em>smaller</em>. You cannot change a single element of a typographic composition without somehow distorting everything else in the space, too.</p>

<p>In other words, the art of typography is really just the art of juggling water balloons and hoping that they all don’t pop.</p>
...
<hr>
<p>A friend asked aloud the other day which typefaces are available for the web that are peculiar and not already worn out or oversaturated in the field. Thankfully, several months ago <a href="http://kupferschrift.de/cms/2016/05/so-many-good-webfonts/">Indra Kupferschmid jotted down a helpful list</a> for everyone to reference.</p>

<hr>
<p>Over on Typeset in the Future, Dave Addey has written another excellent piece that breaks down odd typographic choices in movies, and this time he explores <a href="https://typesetinthefuture.com/2016/06/19/bladerunner/">Blade Runner</a>.</p>
